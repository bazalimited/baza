...
class Locations extends Secure_area implements Idata_controller {
    ...
    function does_have_valid_number_of_locations_for_an_additional_location($email) {
        ...
        $auth_url = (!defined("ENVIRONMENT") or ENVIRONMENT == 'development') ? 'http://phppointofsalestaging.com/allowed_stores.php?email=' . rawurlencode($email) : 'http://baza.rw/allowed_stores.php?email=' . rawurlencode($email);
