    ...
    function create_po() {
        ...
        switch ($criteria) {
            ...
            case 'below_reorder_level_and_out_of_stock':
                ...
                $model->setParams(array('supplier' => $supplier_id, 'category_id' => -1, 'export_excel' => 1, 'offset' => 0, 'inventory' => $criteria == 'below_reorder_level' ? 'all' : 'out_of_stock', 'reorder_only' => false, 'location_id' => $this->Employee->get_logged_in_employee_current_location_id()));
