...
<div class="row hidden-print">
    <div class="col-md-3 col-xs-12 col-sm-6 summary-data">
        <div class="info-seven primarybg-info">
            ...
            <?php
            echo to_currency($total_owner_payment);
            echo '<p>' . lang('reports_owner_payment') . '</p>';
            ?>
        </div>
    </div>
    <div class="col-md-3 col-xs-12 col-sm-6 summary-data">
        <div class="info-seven primarybg-info">
            ...
            <?php
            echo to_currency($total_agent_payment);
            echo '<p>' . lang('reports_agent_payment') . '</p>';
            ?>
        </div>
    </div>
    <div class="col-md-3 col-xs-12 col-sm-6 summary-data">
        <div class="info-seven primarybg-info">
            ...
            <?php
            echo to_currency($total_revenue);
            echo '<p>' . lang('total_revenue') . '</p>';
            ?>
        </div>
    </div>
</div>
...
<?php if ($this->uri->segment(2) != 'closeout') { ?>
    ...
    <?php
    if ($this->uri->segment(2) == 'summary_customers' || $this->uri->segment(2) == 'store_account_activity' || $this->uri->segment(2) == 'specific_customer_store_account' ||
