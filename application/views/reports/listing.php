        ...
        <div class="panel">
            <div class="panel-body">
                <div class="list-group parent-list">
                    ...
                    <?php
                    if ($this->Employee->has_module_action_permission('reports', 'view_internal', $this->Employee->get_logged_in_employee_info()->person_id)) {
                        ?>
                        <a href="#" class="list-group-item" id="internal"><i class="icon ti-download"></i>	<?php echo lang('reports_view_internal_reports'); ?></a>
                    <?php } ?>


                    <?php
                    if ($this->Employee->has_module_action_permission('reports', 'view_external', $this->Employee->get_logged_in_employee_info()->person_id)) {
                        ?>
                        <a href="#" class="list-group-item" id="external"><i class="icon ti-upload"></i>	<?php echo lang('reports_view_external_reports'); ?></a>
                    <?php } ?>
    ...
    <div class="col-md-6" id="report_selection">
        <div class="panel">
            <div class="panel-body child-list">
                ...
                <div class="list-group internal hidden">
                    <a href="<?php echo site_url('reports/revenuep'); ?>" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_revenues_by_period'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_revenues_by_item_type_graph'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_revenues_by_location_graph'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_revenues_ay_agent_graph'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_items_registration_by_agent'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_percentage_of_items_paid_for_vs_items_registration'); ?></a>
                </div>
                <div class="list-group external hidden">
                    <a href="<?php echo site_url('reports/summary_items'); ?>" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_items_by_type_location_and_period'); ?></a>
                    <a href="#" class="list-group-item"><i class="icon ti-bar-chart-alt"></i> <?php echo lang('reports_collected_vs_registered_item_location'); ?></a>
                </div>
