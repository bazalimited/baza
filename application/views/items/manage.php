                ...
                <ul class="list-inline">
                    ...
                    <li style="width: 40%;">		
                        <div class="form-group offset1">
                            <?php echo form_label(lang('common_from') . ': ', 'from_date', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    ...
                    <li>
                        <div class="form-group offset1">
                            <?php echo form_label(lang('common_to') . ': ', 'to_date', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                            <div class="col-sm-9 col-md-9 col-lg-7">
                                <div class="input-group date" data-date="<?php echo $item_info->start_date ? date(get_date_format(), strtotime($item_info->start_date)) : ''; ?>">
                                    <span class="input-group-addon bg">
                                        <i class="ion ion-ios-calendar-outline"></i>
                    ...
                    <div class="piluku-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php if ($this->Employee->has_module_action_permission($controller_name, 'manage_categories', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                                ...
                                <li>
                                    <?php
                                    echo anchor("$controller_name/excel_export/", '<span class="">' . lang("common_excel_export") . '</span>', array('class' => ' ',
