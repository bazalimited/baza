...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel-piluku panel">
            <div class="panel-heading"><?php echo lang("items_manage_categories_and_pricing"); ?></div>
            <div class="panel-body">
                <div id="category_tree">
                    <div class="panel panel-piluku">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <?php echo lang("items_manage_categories_and_pricing"); ?>                    
                                ...
                                <a href="<?php echo site_url('items/add_category') ?>" class="btn btn-primary btn-lg" data-category_id="0" style="float: right; color: #FFFFFF;"><?php echo lang('items_add_root_category'); ?></a>
                            </h3>
                        </div>
                    </div>
                </div>
