    ...
    <div class="col-md-12">
        <div class="panel panel-piluku">
            ...
            <div class="panel-body">
                <div class="item_navigation clearfix text-center" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_dropdown('category_id', $categories, $item_info->category_id, 'class="form-control form-inps" id ="category_id" onchange="return check_category(this.value)"'); ?>
                ...
                <div class="form-group">
                    <?php echo form_label(lang('common_where_found') . ' :', 'where_found', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php
                        echo form_input(array(
                            'name' => 'where_found',
                ...
                <div class="form-group">
                    <?php echo form_label(lang('common_found_item_location') . ' :', 'item_location_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label  required wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_dropdown('item_location_id', $user_locations, $selected_item_location, 'class="form-control form-inps" id ="item_location_id"'); ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        ...
                        if ($item_info->image_id) {
                            ?>
                            <a style="color: #fd0f14;" href="<?php echo site_url("items/delete_item_image") . '/' . $item_info->item_id ?>" onclick="return confirm_image_deletion();"><?php echo lang('common_delete_image'); ?></a>
                            <?php
                        }
                        ?>
                ...
                <div style="display: none;" class="form-group reorder-input <?php
        ...
        <div class="panel panel-piluku" style="display: none;">
            ...
            <div class="panel-body">
                ...
                <?php if ($this->Employee->has_module_action_permission('items', 'see_cost_price', $this->Employee->get_logged_in_employee_info()->person_id) or $item_info->name == "") { ?>
                    ...
                    <?php
                } elseif ($item_info->change_cost_price) {
                ...
                <div class="commission-container <?php
                if (!($item_info->commission_percent != '') && !($item_info->commission_fixed != '')) {
                    echo 'hidden';
                }
                ?>">
                    ...
                    <div class="form-group" id="commission-percent-calculation-container">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                            echo form_dropdown('commission_percent_type', array(
                                'selling_price' => lang('common_unit_price'),
                                'profit' => lang('common_profit'),
                                    ), $item_info->commission_percent_type, array('id' => 'commission_percent_type'))
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="tax-container main <?php
            ...
            <div class="panel-body">
                ...
                foreach ($locations as $location) {
                    ...
                    <?php if ($this->Employee->has_module_action_permission('items', 'edit_quantity', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                        ...
                        if (!isset($is_clone)) {
                            ?>
                            <div class="form-group quantity-input <?php
                            if ($item_info->is_service) {
                                echo 'hidden';
                            }
                            ?>">
                    ...
                    <?php if ($this->Location->count_all() > 1) { ?>
                        ...
                        <div class="item-location-price-container <?php
                        if ($location_items[$location->location_id] === FALSE || !$location_items[$location->location_id]->is_overwritten) {
                            echo 'hidden';
                        }
                        ?>">	
                                 <?php if ($this->Employee->has_module_action_permission('items', 'see_cost_price', $this->Employee->get_logged_in_employee_info()->person_id) or $item_info->name == "") { ?>
                        ...
                        <div class="tax-container <?php
                        if ($location_items[$location->location_id] === FALSE || !$location_items[$location->location_id]->override_default_tax) {
                            echo 'hidden';
                        }
                        ?>">	
                            <div class="form-group">
