        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-body">
                    <h3 style="margin-left: 80px;"><a href="http://baza.rw/buy_additional.php" target="_blank"><?php echo lang('locations_purchase_additional_licenses'); ?> &raquo;</a></h3>
        ...
        <div class="col-md-12">				
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <?php echo form_label(lang('common_Province') . ' :', 'province_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide ' . (!$item_info->item_id ? 'required' : ''))); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_dropdown('province_id', $province_list, $selected_province_id, 'class="form-control" id="province_id" onchange="return search_district(this.value)"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo form_label(lang('common_district') . ' :', 'district_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide ' . (!$item_info->item_id ? 'required' : ''))); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10" id="district_obj">
                            <?php echo form_dropdown('district_id', $district_list, $selected_district_id, 'class="form-control" id="district_id" onchange="return search_sectors(this.value)"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo form_label(lang('common_sector') . ' :', 'sector_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide ' . (!$item_info->item_id ? 'required' : ''))); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10" id="sector_obj">
                            <?php echo form_dropdown('sector_id', $sector_list, $selected_sector_id, 'class="form-control" id="sector_id"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group add-register-table" style="display: none;">	
                    ...
                    <div class="form-group" style="display: none;">
                        <?php echo form_label("<a href='https://baza.rw/mercury_activate.php' target='_blank'>" . lang('locations_enable_credit_card_processing') . '</a>:', 'enable_credit_card_processing', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                    ...
                    <div id="merchant_information" style="display: none;">
                    ...
                    <div class="form-group" id="stock_alert_email_container" style="display: none;">	
                    ...
                    <div style="display: none;" class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 col-lg-9 col-lg-offset-3" style="display: <?php echo $location_info->default_tax_3_rate ? 'none' : 'block'; ?>">
                        <a href="javascript:void(0);" class="show_more_taxes"><?php echo lang('common_show_more'); ?> &raquo;</a>
                    </div>

                    <div style="display: none;" class="more_taxes_container" style="display: <?php echo $location_info->default_tax_3_rate ? 'block' : 'none'; ?>">
...
<?php } ?>
    ...
    $("#emv_info").show();
            ...
            $("#stripe_info").hide(); $("#braintree_info").hide();
    }
    ...
    $("#receive_stock_alert").change(check_enable_stock_alert).ready(check_enable_stock_alert);
            ...
            function search_district(province_id) {
            url = '<?php echo site_url("ajax/province_districts"); ?>';
                    $("#loading").removeClass('hide');
                    $.post(url, {
                    province_id: province_id
                    },
                            function (data) {
                            $('#district_obj').empty().append(data);
                                    $("#loading").addClass('hide');
                            });
            }
    function search_sectors(sector_id) {
    url = '<?php echo site_url("ajax/district_sectors"); ?>';
            $("#loading").removeClass('hide');
            $.post(url, {
            sector_id: sector_id
            },
                    function (data) {
                    $('#sector_obj').empty().append(data);
                            $("#loading").addClass('hide');
                    }
            );
    }
