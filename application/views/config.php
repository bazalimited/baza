        ...
        <div class="col-md-12">
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">	
                        <?php echo form_label(lang('common_phone') . ' :', 'phone', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label  required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10 input-field">
                            <?php
                            echo form_input(array(
                                'class' => 'validate form-control form-inps',
                    ...
                    <div class="form-group">	
                        <?php echo form_label(lang('common_tin') . ' :', 'tin', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label  required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10 input-field">
                            <?php
                            echo form_input(array(
                                'class' => 'validate form-control form-inps',
                                'name' => 'tin',
                                'id' => 'tin',
                                'value' => $this->config->item('tin')));
                            ?>
                        </div>
                    </div>
                    <div class="form-group">	
                        <?php echo form_label(lang('common_address') . ' :', 'address', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label  required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10 input-field">
                            <?php
                            echo form_input(array(
                                'class' => 'validate form-control form-inps',
            ...
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                            ...
                            <div class="form-group">	
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-5">
                                    ...
                                    echo form_input(array(
                                        ...
                                        'size' => '10',
                                        'value' => $this->config->item('default_tax_3_name') !== NULL ? $this->config->item('default_tax_3_name') : lang('locations_sales_tax_3')));
                                    ?>
                                </div>
                            ...
                            <div class="form-group">	
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-5">
                                    ...
                                    echo form_input(array(
                                        ...
                                        'size' => '10',
                                        'value' => $this->config->item('default_tax_4_name') !== NULL ? $this->config->item('default_tax_4_name') : lang('items_sales_tax_4')));
                                    ?>
                                </div>
                            ...
                            <div class="form-group">	
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-5">
                                    ...
                                    echo form_input(array(
                                        ...
                                        'size' => '10',
                                        'value' => $this->config->item('default_tax_5_name') !== NULL ? $this->config->item('default_tax_5_name') : lang('items_sales_tax_5')));
                                    ?>
                                </div>
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                            echo form_dropdown('number_of_decimals', array(
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            <?php
                            echo form_dropdown('number_of_recent_sales', array(
                                '10' => '10',
                                '20' => '20',
                                '50' => '50',
                                '100' => '100',
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            <?php
                            echo form_dropdown('calculate_profit_for_giftcard_when', array(
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            <?php
                            echo form_dropdown('default_type_for_grid', array(
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            echo form_dropdown('commission_percent_type', array(
                                ...
                                'profit' => lang('common_profit'),
                                    ), $this->config->item('commission_percent_type'), array('id' => 'commission_percent_type'))
                            ?>
                        </div>
                    </div>
            ...
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                            echo form_dropdown('id_to_show_on_barcode', array(
                                'id' => lang('common_item_id'),
                                'number' => lang('common_item_number_expanded'),
                                'product_id' => lang('common_product_id'),
                    ...
                    <div id="loyalty_setup">
                        ...
                        <div class="form-group" id="loyalty_option_wrapper">	
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <?php
                                echo form_dropdown('loyalty_option', array(
                    ...
                    <div class="form-group">	
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            ?> 
                            <?php
                            echo form_dropdown('number_of_items_in_grid', $numbers, $this->config->item('number_of_items_in_grid') ? $this->config->item('number_of_items_in_grid') : '14', 'class="form-control" id="number_of_items_in_grid"');
                            ?>
                        </div>
                    </div>				
        ...
        $(".checkForUpdate").click(function (event)
        {
            ...
            $.getJSON($(this).attr('href'), function (update_available)
            {
                ...
                if (update_available)
                {
                    ...
                    window.location = "http://baza.rw/downloads.php";
                }
                else
                {
