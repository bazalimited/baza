<div class="modal-dialog customer-recent-sales">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?php echo lang("common_items_paying_agent"); ?></h4>
        </div>
        <div class="modal-body">
            ...
            <?php echo form_open_multipart('payments/pay_agent/', array('id' => 'pay_agent_orm', 'class' => 'form-horizontal')); ?>
            <table class="table table-bordered table-hover table-striped">
                <tr> <td><?php echo lang('common_agent'); ?></td> <td> <?php echo $agent_info->first_name . ' ' . $agent_info->last_name; ?></td></tr>
            ...
            <input type="hidden" name="agent_id" value="<?php echo $item->created_by_id; ?>" />
