        ...
        <div class="panel panel-piluku">
            ...
            <div class="panel-body">
                ...
                <?php if ($this->Employee->has_module_action_permission('items', 'edit_quantity', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                    ...
                    <div class="form-group hidden-print">
                        <?php echo form_label('Type: ' . ' :', 'transaction_type', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    <div class="form-group hidden-print">
                        <?php echo form_label('Staff name: ' . ' :', 'trans_comment', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <select name="customer_id">
                                ...
                                if (count($customers) > 0) {
                                    foreach ($customers as $customer){
                                        echo '<option value="'.$customer['person_id'].'">'.$customer['last_name'].' '.$customer['first_name'].'</option>';
                                    }
                                }
                                ?>  
                            </select>
            ...
            <div id="barcodes_panel" class="collapse">
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        ...
                        <?php
                        echo form_dropdown('items_number_of_barcodes', $numbers, 1, 'class="form-control" id="items_number_of_barcodes"');
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php
                        echo
                        anchor("items/generate_barcode_labels", '<span class="">' . lang("common_barcode_labels") . '</span>', array('id' => 'generate_barcode_labels',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php
                        echo
                        anchor("items/generate_barcodes", '<span class="">' . lang("common_barcode_sheet") . '</span>', array('id' => 'generate_barcodes',
                            'class' => 'btn btn-primary btn-lg generate_barcodes',
                            'data-item-id' => $item_info->item_id,
                            'target' => '_blank',
                    ...
                    <tbody>
                        <?php foreach ($inventory_data as $row) { ?>
                            <tr>
                                ...
                                <td><?php echo Customer::get_customer_name($row['customer_id']); ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
