				...
				<div class="mail_list_block col-md-12 col-sm-12 no_padding col-xs-12 col-lg-12">
					<div class="mail_list">
						<ul class="list-unstyled mails_holder">
							...
							?>
								<a href="<?php echo site_url('personal/view_message/'.$message['message_id']); ?>"  data-message-id="<?php echo $message['id'] ?>">
									<div class="message_list_block <?php echo $message['message_read']==0 ? 'active' : '';  ?>">
										...
										<div class="right">
                                                                                    <span class="name" style="font-size: 20px;"><i><?php echo $message['message_title']; ?></i></span>
