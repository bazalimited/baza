		...
		<div class="col-md-9">	
			<div class="buttons-list">
				<div class="pull-right-btn">
					<a href="<?php echo site_url('personal/messages'); ?>" id="new-person-btn" class="btn btn-success btn-lg"><span class=""><?php echo lang('messages_inbox') ?></span></a>
			...
			<div class="mail_body">								
				...
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 no_padding mail_brief_holder">
					<div class="heading_block">
						...
						<?php } else { ?>
							<a href="<?php echo site_url('personal/messages') ?>" class="pull-left back"><i class="ion-android-arrow-back"></i></a>
						<?php } ?>
						<h1>
							<div class="name"> <?php echo $message[0]['message_title']; ?></div>
