        ...
        <div class="left-bar hidden-print" >
            ...
            <ul class="list-unstyled menu-parent" id="mainMenu">
                ...
                <?php foreach ($allowed_modules->result() as $module) { ?>
                    <li <?php echo ($module->module_id == $this->uri->segment(1) && $this->uri->segment(2) != 'categories' && $this->uri->segment(2) != 'add_category' && $this->uri->segment(2) != 'view' && $this->uri->segment(2) != 'item_collection') ? 'class="active"' : ''; ?>>
                    ...
                    <?php if ($module->module_id == 'items') {
                        ?>
                        <li <?php
                        $last = $this->uri->segment(2);
                        echo $last == 'view' ? 'class="active"' : '';
                        ?>>
                        ...
                        <li <?php
                        $last = $this->uri->segment(2);
                        echo $last == 'item_collection' ? 'class="active"' : '';
                        ?>>
                            <a tabindex = "-1" href="<?php echo site_url("payments/item_collection"); ?>"  class="waves-effect waves-light">
                                <i class="icon ti-<?php echo $module->icon; ?>"></i>
                                <span class="text"><?php echo lang("items_collection"); ?></span>
                            </a>
                        </li>
                        <li <?php
                        $last = $this->uri->segment(2);
                        echo $last == 'categories' ? 'class="active"' : '';
                        echo $last == 'add_category' ? 'class="active"' : '';
                        ?>>
                            <a tabindex = "-1" href="<?php echo site_url("items/categories"); ?>"  class="waves-effect waves-light">
                                <i class="icon ti-<?php echo $module->icon; ?>"></i>
                                <span class="text"><?php echo lang("items_categories") ?></span>
                            </a>
                        </li>
                    <?php }
                    ?>
