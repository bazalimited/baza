...
<script src="<?php echo base_url().'assets/js/braintree.js'.'?'.APPLICATION_VERSION;?>" type="text/javascript" charset="UTF-8"></script>
<script src="<?php echo base_url().'assets/js/parse_cc_track.js'.'?'.APPLICATION_VERSION;?>" type="text/javascript" charset="UTF-8"></script>
