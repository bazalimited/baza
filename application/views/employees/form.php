                        ...
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            echo form_dropdown('commission_percent_type', array(
                                ...
                                'profit' => lang('common_profit'),
                                    ), $person_info->commission_percent_type, array('class' => 'form-control',
...
<?php if (!$person_info->person_id) { ?>
        remote:
        {
        url: "<?php echo site_url('employees/exmployee_phone_exists'); ?>",
                type: "post"
        },
<?php } ?>
    required:true,
...
<?php } ?>
    ...
    {
<?php if (!$person_info->person_id) { ?>
        remote: <?php echo json_encode(lang('employees_phone_exists')); ?>,
<?php } ?>
    required: <?php echo json_encode(lang('common_username_required')); ?>,
            minlength: <?php echo json_encode(lang('common_username_minlength')); ?>
    },
