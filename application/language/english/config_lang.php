...
$lang['config_prefix']='Request ID Prefix';
...
$lang['config_sale_prefix_required']='Request ID prefix is a required field';
...
$lang['config_print_after_sale']='Print receipt after request';
...
$lang['disable_confirmation_sale']='Disable confirmation for complete request';
...
$lang['config_speed_up_note'] = 'Only recommend if you have more than 10,000 items or collectors';
$lang['config_hide_signature'] = 'Hide Signature';
$lang['config_round_cash_on_sales'] = 'Round to nearest .05 on receipt';
$lang['config_customers_store_accounts'] = 'Collectors Store Accounts';
$lang['config_change_sale_date_when_suspending'] = 'Change request date when suspending request';
$lang['config_change_sale_date_when_completing_suspended_sale'] = 'Change request date when completing suspended request';
$lang['config_price_tiers'] = 'Price tiers';
$lang['config_add_tier'] = 'Add tier';
$lang['config_show_receipt_after_suspending_sale'] = 'Show receipt after suspending request';
$lang['config_backup_overview'] = 'Backup Overview';
$lang['config_backup_overview_desc'] = 'Backing up your data is very important, but can be troublesome with large amount of data. If you have lots of images, items, and requests this can increase the size of your database.';
...
$lang['config_id_to_show_on_sale_interface'] = 'Item ID to Show on Requests Interface';
$lang['config_auto_focus_on_item_after_sale_and_receiving'] = 'Auto Focus On Item Field When using Requests/Receivings Interfaces';
$lang['config_automatically_show_comments_on_receipt'] = 'Automatically Show Comments on Receipt';
$lang['config_hide_customer_recent_sales'] = 'Hide Recent Requests for Collector';
...
$lang['config_disable_subtraction_of_giftcard_amount_from_sales'] = 'Disable giftcard subtraction when using giftcard during request';
...
$lang['config_sales_receipt_info'] = 'Requests & Receipt';
$lang['config_suspended_sales_layaways_info'] = 'Suspended Requests/Layaways';
...
$lang['config_select_sales_person_during_sale'] = 'Select requests person during request';
$lang['config_default_sales_person'] = 'Default requests person';
$lang['config_require_customer_for_sale'] = 'Require collector for request';

$lang['config_hide_store_account_payments_from_report_totals'] = 'Hide store account payments from report totals';
$lang['config_disable_sale_notifications'] = 'Disable request notifications';
...
$lang['config_change_sale_date_for_new_sale'] = 'Change Request Date For New Request';
$lang['config_dont_average_use_current_recv_price'] = 'Don\'t average, use current received price';
$lang['config_number_of_recent_sales'] = 'Number of recent requests by collector to show';
...
$lang['config_remove_customer_contact_info_from_receipt'] = 'Remove collector contact info from receipt';
$lang['config_speed_up_search_queries'] = 'Speed up search queries?';




$lang['config_redirect_to_sale_or_recv_screen_after_printing_receipt'] = 'Redirect to request or receiving screen after printing receipt';
...
$lang['config_do_not_allow_out_of_stock_items_to_be_sold'] = 'Do not allow out of stock items to be requested';
$lang['config_number_of_items_in_grid'] = 'Number of items per page in grid';
$lang['config_edit_item_price_if_zero_after_adding'] = 'Edit item price if 0 after adding to request';
...
$lang['config_billing_is_managed_through_paypal'] = 'Billing is managed through  <a target="_blank" href="http://paypal.com">Paypal</a>. You can cancel your subscription by clicking <a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=BNTRX72M8UZ2E">here</a>. You can <a href="http://baza.rw/update_billing.php" target="_blank">update billing here</a>.';
$lang['config_cannot_change_language'] = 'Language cannot be changed on the demo. To try another language create a new agent and assign them a language of your choosing';
$lang['disable_quick_complete_sale'] = 'Disable request quick complete';
$lang['config_fast_user_switching'] = 'Enable fast agent switching (password not required)';
$lang['config_require_employee_login_before_each_sale'] = 'Require agent login before each request';
$lang['config_keep_same_location_after_switching_employee'] = 'Keep same location after switching agent';
...
$lang['config_enable_customer_loyalty_system'] = 'Enable Collector Loyalty system';
...
$lang['config_number_of_sales_for_discount'] = 'Number of requests for discount';
$lang['config_discount_percent_earned'] = 'Discount percent earned when reaching requests';
$lang['hide_sales_to_discount_on_receipt'] = 'Hide requests to discount on receipt';
$lang['config_hide_price_on_barcodes'] = 'Hide price on barcodes';
$lang['config_always_use_average_cost_method'] = 'Always Use Global Average Cost Price For A Request Item\'s Cost Price';
$lang['config_test_mode'] = 'Test mode';
$lang['config_test_mode_help'] = 'Requests NOT saved';
$lang['config_require_customer_for_suspended_sale'] = 'Require collector for suspended request';
...
$lang['config_do_not_allow_below_cost'] = 'Do NOT allow items to be requested below cost price';
