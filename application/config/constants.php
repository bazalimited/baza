...
define('PENDING_STATUS_CODE', 101);
define('PENDING_COMMIT_TO_WALLET_STATUS_CODE', 102);
define('REJECTED_BY_THE_PAYER', 103);
...
define('ITEM_STATUS_PAYMENT_CONFIRMED_DELIVERY_CONFIRMED', 'Item claiming payment confirmed, Item Collected');
define('ITEM_STATUS_FOUND', 'Item Found');

define('ITEM_STATUS_AGENT_PAID', 'Item Collected and Agent paid');
define('ITEM_STATUS_AGENT_NOT_PAID', 'Item Collected and Agent not paid');
